...
export const decryptMessageNode = (stanza, meId, meLid, repository, logger, workerPool) => {
        ...
        async decrypt() {
            ...
            if (Array.isArray(stanza.content)) {
                for (const { tag, attrs, content } of stanza.content) {
                    ...
                    if (decryptionJid !== author) {
                        logger.info({ author, decryptionJid }, 'Decryption: using mapped LID for PN-addressed message');
                    }
                    if (tag !== 'plaintext') {
